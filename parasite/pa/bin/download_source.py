...
parasite_git_url = 'git@git.chinapnr.com:parasite/Parasite.git'
parasite_config_url = 'http://git.chinapnr.com:8088/parasite/Parasite/raw/master/parasite/config.conf'
